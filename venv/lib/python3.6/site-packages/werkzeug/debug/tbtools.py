...
<html>
  <head>
    ...
    <link rel="stylesheet" href="?__debugger__=yes&ampcmd=resource&ampf=style.css"
        type="text/css">
    <!-- We need to make sure this has a favicon so that the debugger does
         not by accident trigger a request to /favicon.ico which might
         change the application state. -->
    <link rel="shortcut icon"
        href="?__debugger__=yes&ampcmd=resource&ampf=console.png">
    <script src="?__debugger__=yes&ampcmd=resource&ampf=jquery.js"></script>
    <script src="?__debugger__=yes&ampcmd=resource&ampf=debugger.js"></script>
...
%(summary)s
<div class="plain">
  <form action="/?__debugger__=yes&ampcmd=paste" method="post">
    <p>
