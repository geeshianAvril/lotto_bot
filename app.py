...
def makeWebhookResult(req):
    ...
    winning_numbers = {"Power Play": {"2017-12-30": "12-15-23-29,  Multi: 2,  Letter: M",
                       ...
                       "Super Six": {"2017-12-29":  "9-10-13-20-25-27, Multi: E, Jackpot:245,000",
    ...
    win_num = str(winning_numbers[game][date])
